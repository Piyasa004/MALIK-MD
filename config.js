...
global.sudo = process.env.SUDO || '917063080401'
global.devs = '917063080401';
global.website = 'https://github.com/arkhan998/MALIK-MD' //wa.me/+91000000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/yrkITFL.jpeg'
module.exports = {
  
  sessionName:  process.env.SESSION_ID ||  "session",
  botname:   process.env.BOT_NAME === undefined ? '𝐏Î𝐘Å𝐒 𝐌𝐃ツ' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝐏 Î 𝐘 Å 𝐒 ツ' : process.env.OWNER_NAME,
  author:  process.env.PACK_INFO === undefined ? 'ριуαѕ-м∂-вσт' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO === undefined ? '𝐏Î𝐘Å𝐒 𝐌𝐃ツ' : process.env.PACK_INFO.split(";")[1],
